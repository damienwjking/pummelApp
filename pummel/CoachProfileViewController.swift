...
//                            self.connectBT.backgroundColor = UIColor.pmmLightSkyBlueColor()
...
//                            self.connectBT.backgroundColor = UIColor.pmmBrightOrangeColor()
//                        }
//                    } else {
//                        self.connectBT.setImage(UIImage(named: "connect"), for: .normal)
//                        self.connectBT.backgroundColor = UIColor.pmmBrightOrangeColor()
...
//                UIApplication.shared.openURL(NSURL(string: "http://facebook.com/")!)
//            }
//            // Tracker mixpanel
//            if let firstName = self.coachDetail[kFirstname] as? String {
//                let mixpanel = Mixpanel.sharedInstance()
...
//            var userTwitter = self.twitterLink?.substringFromIndex((self.twitterLink!.range(of: "twitter.com/")?.endIndex)!)
//            if ((userTwitter!.range(of: "/")?.startIndex) != nil) {
//                userTwitter = userTwitter?.substringToIndex((userTwitter!.range(of: "/")?.startIndex)!)
//            }
//            
...
//                UIApplication.shared.openURL(twitterLink!)
...
//            } else {
//                //redirect to safari because the user doesn't have Instagram
//                UIApplication.shared.openURL(NSURL(string: "http://twitter.com/")!)
//            }
//            // Tracker mixpanel
//            if let firstName = self.coachDetail[kFirstname] as? String {
//                let mixpanel = Mixpanel.sharedInstance()
...
//            } else {
//                //redirect to safari because the user doesn't have Instagram
//                UIApplication.shared.openURL(NSURL(string: "http://instagram.com/")!) 
//            }
//            // Tracker mixpanel
//            if let firstName = self.coachDetail[kFirstname] as? String {
//                let mixpanel = Mixpanel.sharedInstance()
...
//        } else {
//            return CGSize(width: self.aboutCollectionView.frame.size.width/2, y:self.aboutCollectionView.frame.size.width/2)
//        }
//    }
//    
...
//            
//            ImageVideoRouter.getImage(imageURLString: link, sizeString: widthHeightScreen) { (result, error) in
//                if (error == nil) {
//                    let imageRes = result as! UIImage
