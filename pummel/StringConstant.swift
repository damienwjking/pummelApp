...
let pummelSlogan = "Find a personal trainer or fitness expert in your area, download the app now! http://apple.co/2kWOKUM"
...
let kAddToIphoneContact = "Add Contact"
let kShareTo = "Share"
...
let kMessageInviteContact = "Find a personal trainer or fitness expert in your area, download the app now! http://apple.co/2kWOKUM http://pummel.fit"
